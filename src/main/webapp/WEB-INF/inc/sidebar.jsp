      ...
      <nav id="sidebar" class="side" aria-label="사이드바">
        ...
        <svg style="display:none;">
          <symbol id="ic-group" viewBox="0 0 24 24">
            <path
              d="M16 11a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm-8 2a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm8 2c-3.33 0-10 1.67-10 5v2h20v-2c0-3.33-6.67-5-10-5Zm-8 0C4.67 15 0 16.67 0 20v2h8" />
          </symbol>
          <symbol id="ic-log" viewBox="0 0 24 24">
            <path d="M3 4h18v4H3zm0 6h18v10H3zM7 2h10v2H7z" />
          </symbol>
          <symbol id="ic-board" viewBox="0 0 24 24">
            <path d="M5 3h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H8l-5 4V5a2 2 0 0 1 2-2z" />
          </symbol>
          <symbol id="ic-cal" viewBox="0 0 24 24">
            <path
              d="M7 2v2H5a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2V2h-2v2H9V2zM5 8h14v11H5z" />
          </symbol>
        ...
        <div class="side-head">
          <span id="sideToggle" role="button" tabindex="0" class="side-logo" title="사이드바 접기/펼치기">Menu</span>
        </div>
